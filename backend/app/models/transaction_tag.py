...
class TransactionTag(Base):
    ...
    transaction_id: Mapped[str] = mapped_column(UUID, ForeignKey("transactions.id"), nullable=False)
    tag_id: Mapped[str] = mapped_column(UUID, ForeignKey("tags.id"), nullable=False)
