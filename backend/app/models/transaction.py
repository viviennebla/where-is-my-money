...
from sqlalchemy import String, DateTime, ForeignKey, Numeric, Enum, Index, String
...
class Transaction(Base):
    ...
    transfer_account_id: Mapped[str | None] = mapped_column(String(36), ForeignKey("accounts.id"), nullable=True)

    parent_id: Mapped[str | None] = mapped_column(String(36), ForeignKey("transactions.id"), nullable=True)
